...
class WooProcessImportExport(models.TransientModel):
    ...
    woo_operation = fields.Selection([
        ...
        ("import_specific_orders", "Import/Update Specific Order(s)"),
    ...
    def _onchange_woo_operation(self):
        ...
        if self.woo_operation == 'update_product':
            self.woo_check_running_schedulers('ir_cron_update_product_instance_')
    ...
    def import_specific_product(self):
        ...
        if product_res_list:
            ...
            _logger.info("Created or Updated product queues time -- %s -- seconds.", str(end - start))
    ...
    def get_products_from_woo(self):
        ...
        _logger.info("Created or Updated product queues in %s seconds.", str(end - start))
    ...
    def create_product_queue(self, created_by):
        ...
        queue_vals = {
            ...
            'woo_instance_id': self.woo_instance_id.id if self.woo_instance_id.id else self._context.get(
                "instance_id").id,
    ...
    def import_products_from_xlsx(self):
        """
        This method used to import product using xlsx file in Woo Commerce layer.
